...
<body class="materialdesign">
    ...
    <div class="wrapper-pro">
        ...
        <div class="content-inner-all">
                                ...
                                <div class="header-top-menu tabl-d-n">
                                    <ul class="nav navbar-nav mai-top-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <?php } ?>
                                                <a href="createcategorie.php" class="dropdown-item">Ajouter
                                                </a>
                                            </div>
                                        </li>
                            ...
                            <div class="sparkline8-list shadow-reset">
                                <div class="sparkline8-hd">
                                    <div class="main-sparkline8-hd">
                                        <?php if(isset($id) && isset($login) && isset($password) && isset($adresse))
                                            { 
                                        ?>
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="login-input-head">
                                                ...
                                                password
                                                <input type="text" name="password" class="form-control" value="<?php if(isset($password)){echo $password;}?>"/>
                                                adresse
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="dashboard.php?id=<?php echo $k->id;?>&login=<?php echo $k->login; ?>&password=<?php echo $k->password; ?>&adresse=<?php echo $k->adresse; ?>"><button class="btn btn-primary" name="modifier_utilisateur">Modifier</button> </a>
                                                        <a href="controller.php?identifiant=<?php echo $k->id;?>">
                                                    <button class="btn btn-danger" name="supprimer_utilisateur">Supprimer</button></a>
                                                        <td>
                                                </tr>
                                                <?php
                                                    }
            ...
            <!-- Data table area End-->
            <form method="post" action="control_img.php">
                <input type="file" class="form-control" name="image"></input>
                <input type="submit" class="form-control" name="envoyer_image"></input>
            </form>
        </div>
    </div>
    <!-- Footer Start-->
