<?php
    ...
    $categorie = Categorie::afficher_categorie();
    //print_r($comments);
    //print_r($categorie);
            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        <li class="nav-item">
                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-home"></i> <span class="mini-dn active">Home</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                        ...
                        <li class="nav-item"><a href="sidapublications.php" class="nav-link dropdown-toggle"> <span class="mini-dn">Sida</span></a>
                            
                        </li>
                        <li class="nav-item"><a href="mathpublications.php" > <span class="mini-dn">Mathematique</span></a>
                            
                        </li>
                        <li class="nav-item"><a href="pythonpublications.php"> <span class="mini-dn">Python</span></a>
                                ...
                                <div class="header-top-menu tabl-d-n">
                                    <ul class="nav navbar-nav mai-top-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">Categorie <span class="angle-down-topmenu"><i class="fa fa-angle-down"></i></span></a>
                                            <div role="menu" class="dropdown-menu animated flipInX">
                                                <?php foreach ($categorie as $c) { ?>
                                                <a href="#" class="dropdown-item"><?php echo $c->nom_categorie ?></a>
                                            <?php } ?>
                                            </div>
                                        </li>
                                    ...
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        ...
                                        <li class="nav-item">
                                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                ...
                                                <span class="admin-name"><?php echo $_SESSION["Auth"]->login." id= ".$_SESSION["Auth"]->id ?> </span>
                                                        ...
                                                        <div class="notes-area-wrap">
                                                            ...
                                                            <div class="notes-list-area notes-menu-scrollbar">
                                                                <ul class="notes-menu-list">
                                                                    <li>
                                                                        <a href="#">
                                                                            <div class="notes-list-flow"><div class="notes-img">
                    ...
                    <div class="row">
                            ...
                            <?php foreach ($comments as $comment) { ?>
                                <div class="panel-group adminpro-custon-design" id="accordion">
                                 ...
                                 <?php echo $comment->id_user; ?>
                                    ...
                                    </div><i>Categorie: </i><b><i>
                                    <?php echo $comment->id_categorie; ?></i></b>
                        ...
                        <!-- form for new comments -->
                         <div class="col-lg-12">
                            <div class="admin-pro-accordion-wrap mg-b-15 shadow-reset">
                                <div class="alert-title">
                                    <h2>Ajouter nouveau commentaire</h2>
                                </div>
                            
                                <div class="panel-group adminpro-custon-design" id="accordion">
                                    <div class="panel panel-default">
                                        <form id="comment_form" action="controller.php">
                                            <input type="hidden" name="user" value="<?php echo $_SESSION["Auth"]->id ?>" class="form-control">
                                            <p>Commentez en tant que <b><?php echo $_SESSION["Auth"]->login ?></b></p>
                                            <input type="text" name="commentaire" class="form-control">
                                            <p>Choisir la categorie:</p>
                                            <select name="categorie" class="form-control">
                                                <?php foreach ($categorie as $c) { ?>
                                                <option value="<?php echo $c->id ?>"><?php echo $c->nom_categorie ?></option> 
                                                 <?php } ?>
                                            </select>
                                            <div class="form-group">
                                        <input type="submit" name="creer_commentaire" class="btn btn-success">
                                            </div>
                                        </form>
