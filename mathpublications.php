                        ...
                        <div class="col-lg-12">
                            ...
                            <?php foreach ($comments as $comment) { ?>
                                <div class="panel-group adminpro-custon-design" id="accordion">
                                 ...
                                 <?php
                                    if ($comment->id_categorie == 'math' ){
                                  $categ = $comment->id_categorie;
                                  echo $comment->id_user;
                                   ?>
                                    a ecrit le <?php echo dateFr($comment->date_comment); ?>
                                </a>
                              </h4>
                                        </div>
                                ...
                                <div class="panel-group adminpro-custon-design" id="accordion">
                                    <div class="panel panel-default">
                                        <form action="controller.php">
                                            ...
                                            <p>Commentez en tant que <?php echo "<b>".$_SESSION["Auth"]->login. '</b> en <b>'.$categ ."</b>"?></p>
                                        ...
                                        <input type="submit" name="creer_commentaire" class="btn btn-success" value="Commenter">
                                            </div>
                                        </form>
