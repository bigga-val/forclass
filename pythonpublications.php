                        ...
                        <div class="col-lg-12">
                            ...
                            <?php foreach ($comments as $comment) { ?>
                                <div class="panel-group adminpro-custon-design" id="accordion">
                                 ...
                                 <?php 
                                 if ($comment->id_categorie == 'python' ){
                                    $cat = $comment->id_categorie;
                                    echo $cat;
                                    ...
                                    <i>Categorie: </i><b><i><?php echo $comment->id_categorie; ?></i></b>
                                ...
                                <div class="panel-group adminpro-custon-design" id="accordion">
                                    <div class="panel panel-default">
                                        <form action="controller.php" method="POST">
                                            ...
                                            <p>Commentez en tant que <?php echo "<b>".$_SESSION["Auth"]->login. '</b> en <b>'.$cat ."</b>"?></p>
                                        ...
                                        <input type="submit" name="creer_commentaire" value="Commenter" class="btn btn-success">
                                            </div>
                                        </form>
